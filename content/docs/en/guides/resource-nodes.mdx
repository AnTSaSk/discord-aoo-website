...
- [Power Cores & Energy Vortexes](/docs/guides/cores-and-vortexes/) form the colour-rarity objective category
- [Ancient Lands Portals & Dragon attacks](/docs/guides/portals-and-dragons/) are the two newest objective types
- The [guild coordination workflow](/docs/guides/guild-workflow/) offers a structured approach to objective sessions
